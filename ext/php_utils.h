...
#define PHP_UTILS_ZEPVERSION  "0.9.9-868cb1f92b"
...
#ifdef ZTS
	#define ZEPHIR_GLOBAL(v) TSRMG(utils_globals_id, zend_utils_globals *, v)
#else
	#define ZEPHIR_GLOBAL(v) (utils_globals.v)
#endif

#ifdef ZTS
	#define ZEPHIR_VGLOBAL ((zend_utils_globals *) (*((void ***) tsrm_ls))[TSRM_UNSHUFFLE_RSRC_ID(utils_globals_id)])
#else
